...
export function PgdmFintechNewLandingPage(): React.JSX.Element {
  ...
  const heroImages = React.useMemo(() => [
    '/uploads/fintech/hero_image.png',
  ...
  const canonicalUrl = 'https://www.imas.ac.in/pgdm-fintech-new'

  const onDownload = () => {
    const href = '/uploads/IMAS_PGDM_Fintech_Brochure.pdf' // Update with correct brochure
    try {
  ...
  const tools = [
    ...
    { name: 'Excel & Advanced Analytics', icon: Settings },
    { name: 'Risk Analysis Tools', icon: ShieldCheck },
    { name: 'Blockchain Basics', icon: Database },
    { name: 'Digital Payment Systems', icon: CreditCard },
    { name: 'Data Analysis for Finance', icon: PieChart },
  ]

  const faqs = [
    { q: 'Does IMAS provide placement support for PGDM Fintech?', a: 'Yes, IMAS provides structured placement support with internships and finance/fintech recruiters.' },
    { q: 'Are internships included in this program?', a: 'Yes, a mandatory internship is part of the program.' },
    { q: 'What is the average salary after PGDM Fintech?', a: 'The average package is ₹6.50+ LPA depending on performance.' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-slate-50 to-slate-100 text-slate-900 scroll-smooth">
      <Helmet>
        ...
        <meta name="twitter:title" content="PGDM in Fintech | IMAS Kolkata" />
        <meta name="twitter:description" content="AICTE Approved PGDM in Fintech. Strong placement support." />
      ...
      <div className="relative w-full border-b border-white/10 bg-gradient-to-r from-[#0b1c3a] via-[#143674] to-[#2e7bb3] text-[11px] text-white shadow-sm sm:text-sm">
        ...
        <div className="relative mx-auto flex max-w-[1550px] items-center justify-between px-4 py-2">
          <p className="flex items-center gap-2 font-medium min-w-0">
            ...
            <span className="truncate">PGDM in Fintech • AICTE Approved • Admissions Open • Limited Seats</span>
          </p>
      ...
      <section className="relative overflow-hidden bg-[#0a192f] pt-4 sm:pt-8 pb-8 sm:pb-16 border-b border-white/10">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.05)_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none" />
        </div>
            ...
            <div className="flex-1 md:col-span-8 space-y-1.5 sm:space-y-4">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 sm:mt-6 sm:gap-4">
                {[
                  ...
                  { label: 'Financial Technologies', icon: Landmark },
              ...
              <div className="relative w-full h-[160px] sm:h-[350px] lg:h-[420px] overflow-hidden rounded-2xl shadow-xl border border-white/20 ring-4 ring-white/5">
                {heroImages.map((src, idx) => (
                  <img 
                    key={src}
                    src={src} 
                    alt={`PGDM Fintech Highlight ${idx + 1}`}
                 ...
                 <div className="flex w-max animate-hero-marquee space-x-6 px-4 items-center">
                   {[...Array(2)].map((_, i) => (
                     <React.Fragment key={i}>
                       ...
                       <span className="inline-flex items-center gap-1.5 text-[11px] lg:text-xs font-semibold text-white/90 whitespace-nowrap">
                         <Landmark className="h-3.5 w-3.5 text-sky-400" /> Financial Analytics
                       </span>
                       <span className="inline-flex items-center gap-1.5 text-[11px] lg:text-xs font-semibold text-white/90 whitespace-nowrap">
                         <Building2 className="h-3.5 w-3.5 text-indigo-400" /> Working Professionals
                       </span>
                     </React.Fragment>
                   ))}
                 </div>
        ...
        <div data-animate-on-scroll className="mx-auto max-w-[1550px] px-4 py-5 sm:py-6">
          <div className="grid gap-6 md:grid-cols-2 items-center">
            <div className="order-2 md:order-1 relative h-[250px] sm:h-[400px] overflow-hidden rounded-3xl shadow-xl ring-1 ring-slate-200">
              <img src="/uploads/fintech/hero_image.png" alt="PGDM Fintech Overview" className="absolute inset-0 h-full w-full object-cover object-top transition-transform duration-700 hover:scale-105" onError={(e) => { const t = e.currentTarget as HTMLImageElement; t.style.display = 'none' }} />
            ...
            <div className="order-1 md:order-2 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="text-base sm:text-2xl font-bold font-sans bg-gradient-to-r from-slate-900 to-sky-700 bg-clip-text text-transparent">About PGDM Fintech</h2>
              </div>
              <div className="mb-4 h-1 w-20 rounded-full bg-gradient-to-r from-cyan-400 to-sky-600" />
              <div className="prose prose-sm max-w-none text-slate-700">
                <p className="leading-relaxed">
                  Fintech is transforming the global financial industry by combining finance, technology, and data-driven decision-making. With the rapid growth of digital payments, blockchain, and online banking, companies are actively hiring professionals with fintech expertise.
                </p>
                <p className="leading-relaxed mt-2">
                  The PGDM in Fintech at IMAS prepares students with a strong foundation in finance, analytics, and financial technologies, making it one of the top fintech courses in Kolkata with placement.
                </p>
                ...
                <div className="mt-4 bg-blue-50/50 rounded-2xl p-4 ring-1 ring-blue-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {[
                      { label: 'Digital Banking & Payments' },
                      { label: 'Financial Analytics & Risk Management' },
                      { label: 'Blockchain & Emerging Financial Technologies' },
                      { label: 'Investment & Fintech Strategy' }
                    ].map((i) => (
               ...
               <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-gradient-to-b from-[#f8fafc] to-[#f1f5f9] border border-slate-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
                     ...
                     <ul className="space-y-2 relative z-10">
                        {['Digital Banking & Financial Technologies', 'Financial Analytics', 'Risk Management', 'Blockchain Basics', 'Fintech Ecosystem'].map((item) => (
                  ...
                  <div className="bg-gradient-to-br from-[#0b1c3a] to-[#143674] text-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow relative overflow-hidden">
                     ...
                     <ul className="space-y-2 relative z-10">
                        {['Advanced Fintech Applications', 'Investment Analytics', 'AI in Finance', 'Fintech Strategy & Innovation', 'Capstone Project (Industry-Based)'].map((item) => (
          ...
          <div className="grid lg:grid-cols-12 gap-8">
               ...
               <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                     {[
                        ...
                        'Fintech Tools & Financial Analytics Training',
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
               ...
               <div className="rounded-3xl bg-gradient-to-br from-[#143674] to-[#0b1c3a] p-6 text-white shadow-xl ring-1 ring-slate-800 h-full flex flex-col">
                 <h3 className="text-xl font-bold mb-2 flex items-center gap-2"><Briefcase className="h-6 w-6 text-cyan-400" /> Designed for Working Professionals</h3>
                 <p className="text-xs text-sky-200 mb-6">IMAS PGDM is also structured for professionals looking to upgrade their careers.</p>
                 <div className="flex flex-col gap-4 flex-grow">
                   <ul className="space-y-4">
                     <li className="flex items-start gap-3 text-sm bg-white/5 p-3 rounded-lg border border-white/10"><CheckCircle className="h-5 w-5 text-emerald-400 flex-shrink-0" /> Flexible Class Timings & Hybrid Learning Mode (Online + Offline)</li>
                     ...
                     <li className="flex items-start gap-3 text-sm bg-white/5 p-3 rounded-lg border border-white/10"><CheckCircle className="h-5 w-5 text-emerald-400 flex-shrink-0" /> Career Transition & Mid-Level Role Opportunities</li>
                     <li className="flex items-start gap-3 text-sm bg-white/5 p-3 rounded-lg border border-white/10"><CheckCircle className="h-5 w-5 text-emerald-400 flex-shrink-0" /> Practical Learning applicable to current job</li>
                   </ul>
                 </div>
               </div>
            </div>
      ...
      <section id="placements" className="relative border-b border-slate-200 bg-white">
        <div data-animate-on-scroll className="mx-auto max-w-[1550px] px-4 py-8 sm:py-12">
          <div className="flex flex-col gap-1 mb-6">
            ...
            <p className="text-sm sm:text-base font-medium text-slate-600 mt-2">Among the best PGDM Fintech colleges in Kolkata with placement</p>
          </div>
                 ...
                 <div className="grid sm:grid-cols-2 gap-8">
                   <div>
                     ...
                     <div className="flex flex-col gap-2">
                       {['Financial Analyst', 'Fintech Analyst', 'Risk Analyst', 'Investment Analyst', 'Banking Professional', 'Digital Payments Specialist'].map((role) => (
                   ...
                   <div>
                     ...
                     <div className="flex flex-col gap-2">
                       {['Banks & Financial Institutions', 'Fintech Companies', 'NBFCs', 'Consulting Firms', 'Investment Firms'].map((sector) => (
        ...
        <div data-animate-on-scroll className="mx-auto max-w-[1550px] px-4 py-5 sm:py-6">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div id="admissions-2026" className="rounded-2xl bg-gradient-to-br from-[#143674] to-[#0b1c3a] p-4 sm:p-6 text-white shadow-sm ring-1 ring-slate-200">
              ...
              <p className="text-xs sm:text-sm opacity-90 mb-4">Limited seats available in the High Demand Fintech Program. Apply early to secure your spot.</p>
        ...
        <div data-animate-on-scroll className="relative z-10 mx-auto max-w-[1550px] px-4 py-6 sm:py-8">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-slate-50 p-4 sm:p-6 ring-1 ring-slate-200 flex flex-col gap-3">
              ...
              <p className="text-[13px] sm:text-sm text-slate-600">Interested in the PGDM Fintech Program? Our admissions team will reach out within 24 hours.</p>
