...
import {
  ...
  Calendar, Clock, Building2, Download
} from 'lucide-react';
      ...
      <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:border-transparent transition-all duration-200 bg-white ${
                          formErrors.name 
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full pl-10 pr-10 py-3 border rounded-xl focus:ring-2 focus:border-transparent appearance-none bg-white transition-all duration-200 cursor-pointer ${
                          formErrors.program 
                            ? 'border-red-300 focus:ring-red-200 bg-red-50/50' 
                            : formData.program
                            ? 'border-[#143674] focus:ring-[#143674]/20'
                ...
                <div>
                  ...
                  <div className="relative">
                    <MessageSquare className={`absolute left-3 top-3 h-5 w-5 transition-colors duration-200 ${formData.message ? 'text-[#143674]' : 'text-gray-400'}`} />
                    <textarea
                      name="message"
                      value={formData.message}
                      onChange={handleInputChange}
                      rows={4}
                      className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:border-transparent transition-all duration-200 resize-none bg-white ${
                        formData.message
                          ? 'border-[#143674] focus:ring-[#143674]/20'
                          : 'border-gray-300 focus:ring-[#143674]/20'
                      }`}
                      placeholder="Tell us about your background, career goals, or any specific questions you have about our programs..."
                    />
                  </div>
                  <p className="mt-1 text-xs text-gray-500">Help us understand your goals better (optional)</p>
                </div>
