      ...
      <header className="sticky top-0 z-40 bg-slate-800 backdrop-blur shadow-md/70">
        <div className="mx-auto flex max-w-[1550px] items-center justify-between px-4 py-3">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-300 md:flex">
            ...
            <a href="#program-features" className="flex items-center gap-1 hover:text-[#2e7bb3] transition-colors duration-200"><Award className="h-4 w-4" /><span>Programme Features</span></a>
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 p-6 overflow-y-auto">
            <ul className="space-y-2">
              ...
              <li><a href="#fintech-learning" onClick={() => setMobileMenuOpen(false)} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-gray-700 hover:text-[#2e7bb3] hover:bg-slate-50 transition-colors"><Layers className="h-5 w-5" /><span className="font-medium">FinTech Learning</span></a></li>
