...
export function InternshipProcessSection() {
  ...
  return (
    <section ref={sectionRef} className="bg-white px-4 py-12">
      <div className="mx-auto max-w-6xl">
        <div className="text-center sm:text-left">
          <div className="text-xs font-semibold uppercase tracking-wide text-[#444655]">Simple 5-Step Process</div>
          <h2 className="mt-2 text-xl font-semibold text-[#143674] mb-8">Internship Process</h2>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <div
                        className={`flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold text-white transition-all duration-300 ${
                          isActive
                      ...
                      {!isLast && (
                        <div className="absolute left-1/2 top-10 h-[calc(100%+24px)] w-px -translate-x-1/2 bg-[#dfe6ff]" />
                      )}
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-semibold text-[#143674]">{s.title}</h3>
                          <p className="mt-1 text-sm text-[#444655]">{s.description}</p>
                        </div>
                      </div>
                    </div>
                  </div>
