        ...
        <div className="w-full px-6">
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
              <span className="font-semibold text-[12px]  md:text-[14px]">Final Admission Phase I – Apply Before the Extended to Deadline! 30th June , 2026</span>
            ...
            <div className="hidden md:flex items-center gap-3">
              <span className="hidden lg:inline">Application Deadline 30 June, 2026</span>
              <Button 
                variant="ghost"
